                    ...
                    <div className="footer-grid">
                        ...
                        <div className="footer-brand">
                            <Link to="/" className="footer-logo">
                                <span className="footer-logo-text">Rexgold</span>
                                <span className="footer-logo-subtitle">Hotel & Suites</span>
                            </Link>
                            <p className="footer-description">
                                Experience unparalleled luxury and exceptional service at Rexgold Hotel.
                                Your perfect stay awaits us.
                            </p>
                ...
                <div className="container">
                    <div className="footer-bottom-content">
                        <p className="footer-copyright">
                            © {currentYear} Rexgold Hotel & Suites. All rights reserved.
                        </p>
